                ...
                <Row>
                    <Col md={12} >
                        <Card className='Recent-Users'>
                            <Card.Header>
                                <Card.Title as='h5'> Vos demandes</Card.Title>
                            </Card.Header>
                            <Card.Body className='px-0 py-2'>
                                <Table responsive hover>
                                    ...
                                    <tr className="unread">
                                        ...
                                        <td>
                                            <h6 className="mb-1">LAHLALI Hatim</h6>
                                            <p className="m-0">ENSIAS is good but food is good to</p>
                                        </td>
                                        <td>
                                            <h6 className="text-muted"><i className="fa fa-circle text-c-green f-10 m-r-15"/>11 MAY 12:56</h6>
                                        </td>
                                        <td><a href={DEMO.BLANK_LINK} className="label theme-bg2 text-white f-12">update</a><a href={DEMO.BLANK_LINK} className="label theme-bg text-white f-12">more</a></td>
                                    </tr>
                                    <tr className="unread">
                                        <td><img className="rounded-circle" style={{width: '40px'}} src={avatar3} alt="activity-user"/></td>
                                        <td>
                                            <h6 className="mb-1">LEKMAD Mohammed</h6>
                                            <p className="m-0">NO racism we are all equal </p>
                                        </td>
                                        <td>
                                    ...
                                    <tr className="unread">
                                        ...
                                        <td>
                                            <h6 className="mb-1">KHALIFA Oussama</h6>
                                            <p className="m-0">Marrakech kech kech yeaahhh…</p>
                                        </td>
                                        <td>
                            ...
                            <Card.Body className='border-bottom'>
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col">
                                        ...
                                        <span className="d-block text-uppercase">total idees</span>
                                    </div>
                                </div>
                            </Card.Body>
                            <Card.Body>
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col">
                                        ...
                                        <span className="d-block text-uppercase">totale idee accepte</span>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
